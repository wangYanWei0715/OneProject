...
#file_content+="         sudo rm -rf \$BASE_DIR_I/hsm-os 2> /dev/null \n"
#file_content+="         sudo rm -rf /home/hsm-os/xbase_projectid  2> /dev/null \n"
#file_content+="  else \n"
...
#file_content+="   find \$TARGET_DIR/lib -mindepth 1 -maxdepth 1  ! -path \"\$TARGET_DIR/lib/curl\"  -exec rm -rf {} + \n"
#file_content+="   find \$TARGET_DIR -mindepth 1 -maxdepth 1 ! -path \"\$TARGET_DIR/data\" ! -path \"\$TARGET_DIR/lib\"   -exec rm -rf {} + \n"
#file_content+="   rm -rf \$TARGET_DIR/data/hsm-sk/ \n"
